...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Exception{
		...
		System.out.println("came inside "+PropertyFileUtil.getValueForKey("Browser"));
		
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Chrome")){
			System.setProperty("webdriver.chrome.driver", "D:\\madhu.p\\StockAccounting_Maven\\Drivers\\chromedriver.exe");
	...
	public static String generatedate(){
				...
				SimpleDateFormat sdf=new SimpleDateFormat ("YYYY_DD_MM_SS");
			return sdf.format(date);
		
	}

		public void CaptureData(WebDriver driver,String locatortype,String locatorvalue) throws IOException{
			String supplierdata="";
			if(locatortype.equalsIgnoreCase("id")){
